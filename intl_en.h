...
#define INTL_LANG "EN"
#define INTL_CLOCK "Sensor.Community clock"
const char INTL_CONFIGURATION[] PROGMEM = "Configuration";
#define INTL_WIFI_SETTINGS "WiFi"
...
const char INTL_FUNCTIONS_SETTINGS[] PROGMEM = "Settings";
...
const char INTL_SENSORS_CHOICE[] PROGMEM = "Sensors";
const char INTL_CALL_INTERVAL[] PROGMEM = "Call interval (sec)";
...
const char INTL_RESTART_SENSOR[] PROGMEM = "Restart clock";
...
const char INTL_TIME_TO_FIRST_CALL[] PROGMEM = "Still {v} seconds until first API call.";
const char INTL_TIME_SINCE_LAST_CALL[] PROGMEM = " seconds since last call.";
const char INTL_TIME_UTC[] PROGMEM = "Time (UTC)";
const char INTL_TIME_OFFSET[] PROGMEM = "Time offset (from UTC)";
...
#define INTL_TIME "Time (UTC)"
#define INTL_VALUE "Value"
const char DBG_TXT_CONNECTING_TO[] PROGMEM = "Connecting to ";
#define INTL_REPORT_ISSUE "Report issue"
const char INTL_SENSORS_LIST[] PROGMEM = "List of sensors";
#define INTL_SENSORS_INFO "10 sensors max., comma separated"
const char INTL_RANDOM[] PROGMEM = "Random order";
